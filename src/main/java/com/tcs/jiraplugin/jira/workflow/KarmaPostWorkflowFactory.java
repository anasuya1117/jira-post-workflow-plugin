package com.tcs.jiraplugin.jira.workflow;
...
public class KarmaPostWorkflowFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public KarmaPostWorkflowFactory(WorkflowManager workflowManager) {
