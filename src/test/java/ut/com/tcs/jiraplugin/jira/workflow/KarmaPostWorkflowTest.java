package ut.com.tcs.jiraplugin.jira.workflow;

import com.tcs.jiraplugin.jira.workflow.KarmaPostWorkflow;
...
public class KarmaPostWorkflowTest
{
    public static final String MESSAGE = "my message";

    protected KarmaPostWorkflow function;
    ...
    public void setup() {
        ...
        function = new KarmaPostWorkflow() {
